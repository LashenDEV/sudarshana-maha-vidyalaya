...
import {photosenvironmentday} from "./imageSource";
import "./Gallery.css";
    ...
    return (
        <>
            <div className={model ? "model open" : "model"}>
                ...
                <MDBBtn className="icon d-flex align-items-center justify-content-center" color="danger"
                        onClick={() => setModel(false)}><MDBIcon icon="times"/></MDBBtn>
            </div>
            <div>
                <h3 style={{textAlign: "right"}}>2022</h3>
                <hr></hr>
                <div className="gallery">
                    {photosenvironmentday.map((val, key) => {
                        return (
                            <div>
                                {val.year === 2022 &&
