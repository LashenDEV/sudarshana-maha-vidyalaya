        ...
        <>
            <div className="card text-center" style={{marginBottom: "20px"}}>
                ...
                <div className="card-body">
                    <h4 className="btn btn-outline-primary btn-lg text-white"
                        style={{backgroundColor: "#080c34"}}>{title}</h4>
                </div>
            </div>
        </>
    );
                ...
                <div className="container-fluid d-flex justify-content-center">
                    <div className="row">
                        <div className="col-md-4">
                            <Link to='/sudarshana-maha-vidyalaya/galleryPageSportmeet'><GalleryCard title="Sportmeet"
                        ...
                        <div className="col-md-4">
                            <Link to='/sudarshana-maha-vidyalaya/galleryPagescience'><GalleryCard title="Science Day"
                        ...
                        <div className="col-md-4">
                            <Link to='/sudarshana-maha-vidyalaya/galleryPageEnglishday'><GalleryCard title="English Day"
