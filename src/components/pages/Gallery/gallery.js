                    ...
                    <div className="container-fluid d-flex justify-content-center">
                        <div className="row">
                            <div className="col-md-4 animate__animated animate__bounceIn">
                                <Link to='/galleryPageSportmeet'><GalleryCard
                                    title="Sportmeet"
                                    imgurl="https://www.thepapare.com/wp-content/uploads/705bb26fd753f4567479c69a19885d22.jpg"/></Link>
                            </div>
                            <div className="col-md-4 animate__animated animate__bounceIn">
                                <Link to='/galleryPageartday'><GalleryCard title="Art Day"
                            ...
                            <div className="col-md-4 animate__animated animate__bounceIn">
                                <Link to='/galleryPagescience'><GalleryCard
                                    title="Science Day"
                            ...
                            <div className="col-md-4 animate__animated animate__bounceIn">
                                <Link to='/galleryPageChildrensday'><GalleryCard
                                    title="Children Day"
