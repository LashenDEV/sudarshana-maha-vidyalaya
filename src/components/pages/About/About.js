            ...
            <div className="card shadow p-3 mb-5 bg-body rounded h-100">
              <div className="card-body">
                ...
                <p className="paragraph">
                  ...
                  <br></br>
                  <b> Web Site :</b> sudarshanamv.lk <br></br>
                  <br></br>
                  <b>School Type :</b> Central collage <br></br>
                  <br></br>
                  <b> Class Range :</b> Grade 1-13 <br></br>
                  <br></br>
                  <b> National Type :</b> Mixed <br></br>
                  <br></br>
                  <b> Language medium for laurning: </b> Sinhala/English{" "}
                  <br></br>
                  <br></br>
                  <b>Education Division :</b> Passara <br></br>
                  <br></br>
                  <b> Education Zone: </b> badulla <br></br>
                  <br></br>
                  <b> Province: </b> Uva <br></br>
                  <br></br>
                  <b>School Number :</b> +9477-6753565<br></br>
                  <br></br>
                  <b> School Census No: </b> 54432 <br></br>
                  <br></br>
            ...
            <div className="card shadow p-3 mb-5 bg-body rounded h-100">
              <div className="card-body">
                ...
                <p className="d-flex justify-content-center align-items-center">
                  ...
                  <br></br>
                  සුදර්ශන මහා විදුහල් ජනනිය <br></br>
                  <br></br>
                ...
                <div className="d-flex justify-content-center align-items-center">
                  <b>
                    <p>
                      පද රචනය: රත්න ශ්‍රී විජේසිංහයන් <br></br>
                      <br></br>
                      ස්වර රටා: ගුරු උපදේශිකා ස්වර්ණා මොහොට්ටාල<br></br>
                      <br></br>
          ...
          <form>
            <ol>
              ...
              <p>
                ...
                corner of the shirt pocket.<br></br>
                ...
                socks are not visible when standing.<br></br>
                Shorts (Grade 1 – 9) – Junior students must wear short navy blue
                trousers up to their knees.<br></br>
                ...
                of the hair is strictly prohibited.<br></br>
