            ...
            <div className="row">
                <div className="col-md-8 pb-5 px-5">
                    ...
                    <p className="lh-lg paragraph lead pb-4"> Sudarshan Maha Vidyalaya, Galle is a shining star in the
                        ...
                        Buddhist school. And now it is a leading secondary school among thousand school project. It is
                        located in in Galle Baddegama road, Uluwitike which is 5km far from galle town. Presently Mr.
                        P.D.K. Vidanapathirana Principal of the school taking over his responsibilities to uplits the
                        status of
                        the school after there principals and the tireless services rendered by the former principal
                        Ven.
                        Thalawe Dharmarama Thero who crowned the school and name it as Sudarshan Maha Vidyalaya tribute
                        to the late minister of education. The current strength of the school is more than 1000 students
                        from grade 1 to grade 13. There are six advanced level streams are available, Arts, Commerce,
                        Maths,
                        Bio Science, Engineering Technology and Bio Systems Technology, and followed with bilingual
                    ...
                    <div className="row text-center">
                        <div className="col-md-6">
                            <div className="card p-4 h-100 d-flex align-items-center border-0">
                                ...
                                <br/>
                                <p>පිරිපුන් දැයක් උදෙසා පිරිපුන් දරුවෙක්. <br/><br/>
                                    பூரண சாதிக்காக பூரண பிள்னை. <br/><br/>
                        ...
                        <div className="col-md-6">
                            <div className="card p-4 h-100 border-0">
                                ...
                                <p>
                                    ...
                                    சிறந்த பிளளை ஒள்றை பெற்றுவதற்காக பயனுள்ள சூழலை அமையுதல். <br/><br/>

                                    Creating a productive school environment capable of producing a Total Child.
                                </p>
                            </div>
                        </div>
